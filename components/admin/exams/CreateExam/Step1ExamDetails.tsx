  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900/60">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <label className="text-sm"><span className="text-slate-500">Exam Title*</span><input className="mt-1 w-full rounded-lg border px-3 py-2 dark:border-slate-700 dark:bg-slate-950" value={form.title} onChange={(e) => set("title", e.target.value)} /></label>
        ...
        <label className="text-sm"><span className="text-slate-500">Exam Date*</span><input className="mt-1 w-full rounded-lg border px-3 py-2 dark:border-slate-700 dark:bg-slate-950" type="date" value={form.examDate} onChange={(e) => set("examDate", e.target.value)} /></label>
      ...
      <div className="mt-6 flex justify-end"><button className="rounded-xl bg-blue-600 px-5 py-2 text-white" onClick={onNext}>Next Step</button></div>
    </div>
  );
}
