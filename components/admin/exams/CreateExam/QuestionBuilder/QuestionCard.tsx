  ...
  return (
    <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-800">
      <div className="flex justify-between gap-3">
        ...
        <div className="flex gap-1"><button onClick={() => onMove("up")}><ArrowUp size={16} /></button><button onClick={() => onMove("down")}><ArrowDown size={16} /></button><button onClick={onDelete}><Trash2 size={16} /></button></div>
      </div>
