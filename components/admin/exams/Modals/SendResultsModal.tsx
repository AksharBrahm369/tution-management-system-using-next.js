  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 dark:bg-slate-900">
        ...
        <select aria-label="Result sending channel" className="mt-4 w-full rounded-lg border px-3 py-2" value={channel} onChange={(e) => setChannel(e.target.value as "EMAIL" | "SMS" | "WHATSAPP" | "ALL")}>
